...
class ConsultationForm extends Form {
	...
	public function __construct($name = null) {
		...
		$this->add ( array (
				...
				'type' => 'Text',
				'options' => array (
						'label' => iconv ( 'ISO-8859-1', 'UTF-8', 'Doppler couleur, pulse, continu, tissulaire:')
				),
				'attributes' => array (
						'readonly' => 'readonly',
		...
		$this->add ( array (
				...
				'type' => 'Text',
				'options' => array (
						'label' => iconv ( 'ISO-8859-1', 'UTF-8', 'Echographie gyn&eacute;cologique:')
				),
				'attributes' => array (
						'readonly' => 'readonly',
		...
		$this->add ( array (
				...
				'type' => 'Text',
				'options' => array (
						'label' => iconv ( 'ISO-8859-1', 'UTF-8', 'Echographie obst&eacute;trique:')
				),
				'attributes' => array (
						'readonly' => 'readonly',
		...
		$this->add ( array (
				...
				'type' => 'Text',
				'options' => array (
						'label' => iconv ( 'ISO-8859-1', 'UTF-8', 'Consultation s&eacute;nologie:')
				),
				'attributes' => array (
						'readonly' => 'readonly',
		...
		$this->add ( array (
				...
				'type' => 'Text',
				'options' => array (
						'label' => iconv ( 'ISO-8859-1', 'UTF-8', 'Temp&eacute;rature (�C)' )
				),
				'attributes' => array (
		...
		$this->add ( array (
				...
				'type' => 'Text',
				'options' => array (
						'label' => iconv('ISO-8859-1', 'UTF-8','Fr&eacute;quence respiratoire')
				),
				'attributes' => array (
		...
		$this->add ( array (
				...
				'type' => 'Text',
				'options' => array (
						'label' => iconv('ISO-8859-1', 'UTF-8', 'Glyc&eacute;mie capillaire (g/l)') 
				),
				'attributes' => array (
		...
		$this->add ( array (
				...
				'options' => array (
						...
						'value_options' => array (
								'1' => iconv ( 'ISO-8859-1', 'UTF-8', 'Anesth&eacute;sie1' ),
								'2' => iconv ( 'ISO-8859-1', 'UTF-8', 'Anesth&eacute;sie2' ),
								'3' => iconv ( 'ISO-8859-1', 'UTF-8', 'Anesth&eacute;sie3' )
						)
				),
				'attributes' => array (
						'readonly' => 'readonly',
		...
		$this->add ( array (
				...
				'type' => 'Text',
				'options' => array (
						'label' => iconv ( 'ISO-8859-1', 'UTF-8', 'Intervention Pr&eacute;vue :')
				),
				'attributes' => array (
						'readonly' => 'readonly',
