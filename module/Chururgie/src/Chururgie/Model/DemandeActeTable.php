		...
		if( $this->getDemande($id_cons)->current() ){ 
			...
			foreach ($this->getDemande($id_cons) as $listeDemande) {
				if(!in_array($listeDemande['idActe'], $examensActe)){
					...
					/** Emplacement pour la suppression des donn�es **/
					/** Emplacement pour la suppression des donn�es **/
...
// 		}
	...
	/**
	 * 
	 * Recuperer la liste des actes de la consultation donn�e en param�tre
	 */
...
// 	/**
// 	 * Recuperer la liste des examens Biologiques Effectu�s et Envoy�s par le laborantion (biologiste)
// 	 */
...
// 	/**
// 	 * Recuperer la liste des examens Biologiques Effectu�s par le laborantion (biologiste)
// 	 */
...
// 				return $result;
// 			}else {
// 				//C'est ici qu'on met appliquer � 1
